...
本文件是本仓库的长期工程约定，供 Codex 与协作者在写代码时共同遵循。
...
- 遵循 [Apple Design](https://developer.apple.com/design/) 规范：优先使用系统组件，确保层级清晰、操作一致；适配多设备、深浅色与动态字体；兼顾无障碍与隐私；Liquid Glass 使用系统 API，支持旧系统降级。
