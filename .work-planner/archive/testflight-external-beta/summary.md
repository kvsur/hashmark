...
- In:
  ...
  - 维护一份无需 Codex 辅助即可独立完成后续升级、上传和 TestFlight 分发的发布手册。
- Out:
...
8. `docs/App-Store-Release-Runbook.md` 覆盖固定字段、重复步骤、版本规则、验收标准和失败恢复，作者可据此独立完成下一次迭代。
...
| C19 | App Store Connect 激活通过确认 | `.work-planner/context/app-store-connect-activation-confirmed-2026-08-31.md` | S1 解除身份审核与后台激活阻塞的用户确认 |
| C20 | Apple 发布后台访问核对 | `.work-planner/context/apple-backend-access-verification-2026-08-31.md` | S1 会员、角色、协议、Team、App ID 与证书入口的最终验收 |
| C21 | Hashmark App Store 名称占用结果 | `.work-planner/context/hashmark-app-name-unavailable-2026-08-31.md` | S3.1 商店名称验证失败与备选名决策依据 |
| C22 | App Store Connect App 条目创建结果 | `.work-planner/context/app-store-connect-app-created-2026-08-31.md` | S3.1 商店名称、Bundle ID、SKU、Apple ID 与隐私政策 URL 验收 |
| C23 | App ID 与 iCloud 容器核对 | `.work-planner/context/app-id-icloud-verification-2026-08-31.md` | S3.2 Explicit App ID、iCloud capability 与生产容器验收 |
| C24 | 独立发布交接要求 | `.work-planner/context/independent-release-handoff-requirement-2026-08-31.md` | S3–S7 的可复现记录与独立升级发布手册要求 |
| C25 | Xcode 分发签名账户阻塞 | `.work-planner/context/xcode-distribution-account-block-2026-08-31.md` | S3.3 Release/archive 成功证据与 No Accounts / No profiles 恢复步骤 |
| C26 | App Store 分发签名导出验收 | `.work-planner/context/distribution-export-verification-2026-08-31.md` | S3.3/S3.4 Cloud Managed Distribution、App Store profile、版本和 entitlement 最终验收 |
| C27 | S4 正式 Release archive 验收 | `.work-planner/context/s4-formal-archive-verification-2026-08-31.md` | S4.1/S4.2 Archive、隐私、图标、dSYM 与 entitlement 验收 |
| C28 | S4 App Store Connect 上传结果 | `.work-planner/context/s4-upload-accepted-2026-08-31.md` | S4.3/S4.4 服务端分析与正式构建上传成功证据 |
| C29 | S4 TestFlight 处理完成验收 | `.work-planner/context/s4-testflight-processing-verification-2026-08-31.md` | S4.5 二进制验证、出口合规、版本、设备族、符号与 entitlement 最终证据 |
| C30 | Owner Smoke 内部组验收 | `.work-planner/context/s5-owner-smoke-group-created-2026-08-31.md` | S5.1 内部组、自动分发、Account Holder 邀请与构建归组证据 |

## Assumptions and Open Questions

| Item | Status | Why it matters | Resolution point |
|---|---|---|---|
| Apple 身份复核何时完成 | confirmed | 2026-08-31 已收到激活通过通知并完成后台访问验收 | S1.1 |
| App Store 商店名称 | confirmed | `Hashmark` 已被占用；用户改用 `Hashmark: AI Markdown Editor` | S3.1 |
| App Store Connect 主语言使用 English (U.S.) | assumed | 全球 Beta 的默认元数据语言；以后可增加本地化 | S3.1 |
| Beta 反馈邮箱使用 `hello1024lc@gmail.com` | confirmed | 仓库 README 已公开该支持邮箱 | S2.2 |
