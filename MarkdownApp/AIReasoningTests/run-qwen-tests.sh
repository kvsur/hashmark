...
output_dir=$(mktemp -d "${TMPDIR:-/tmp}/qwen-tests.XXXXXX")
...
xcrun swiftc \
  ...
  "$app_dir/Models/AI/Qwen/QwenWire.swift" \
  "$app_dir/Models/AI/Qwen/QwenRequestBuilder.swift" \
  "$app_dir/Models/AI/Qwen/QwenStreamParser.swift" \
  "$test_dir/QwenContractTests.swift" \
  -o "$output_dir/QwenContractTests"

"$output_dir/QwenContractTests"
