...
zsh "${test_dir:h}/AISettingsTests/run-profile-tests.sh"
"$test_dir/run-provider-tests.sh"
zsh "$test_dir/run-manifest-governance-tests.sh"
zsh "$test_dir/run-governance-audit.sh"
zsh "$test_dir/run-capability-resolver-tests.sh"
...
zsh "$test_dir/run-model-drift-tests.sh"
