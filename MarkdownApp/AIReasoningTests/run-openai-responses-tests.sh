...
output_dir=$(mktemp -d "${TMPDIR:-/tmp}/openai-responses-tests.XXXXXX")
...
xcrun swiftc \
  ...
  "$app_dir/Models/AI/OpenAIResponses/OpenAIResponsesWire.swift" \
  "$app_dir/Models/AI/OpenAIResponses/OpenAIResponsesRequestBuilder.swift" \
  "$app_dir/Models/AI/OpenAIResponses/OpenAIResponsesStreamParser.swift" \
  "$test_dir/OpenAIResponsesContractTests.swift" \
  -o "$output_dir/OpenAIResponsesContractTests"

"$output_dir/OpenAIResponsesContractTests"
