...
output_dir=$(mktemp -d "${TMPDIR:-/tmp}/document-step7-tests.XXXXXX")
...
xcrun swiftc -parse-as-library \
  ...
  "$test_dir/DocumentReleaseQATestSupport.swift" \
  "$test_dir/DocumentReleaseQATests.swift" \
  -o "$output_dir/DocumentReleaseQATests"
"$output_dir/DocumentReleaseQATests"

print "DocumentReleaseQAStep7Tests: PASS"
